    ...
    return ( 
      ...
      <div className='consulta-block'>
        ...
        <div style={{fontSize: '25px'}} className='blog-content'>
          ...
          <p>Si estás gastando dinero en Marketing pero no aumentas tus ventas... si Facebook o Instagram ya no te son rentables y temes que tu negocio no pueda sostenerse por más tiempo... Entonces, podemos ayudarte.</p>
          <p>O... Si esas planeando lanzar tu nuevo emprendimiento o un nuevo producto, también podemos ayudarte.</p>
