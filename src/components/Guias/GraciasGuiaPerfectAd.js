...
class GraciasGuiaPerfectAd extends React.Component {
  ...
  sendToLinkedIn = () => {
    window.location.href = "https://www.spertomedia.com/checkout/call-15"
  }
      ...
      <div>
        <div className='consulta-block'>
          ...
          <div style={{fontSize: '25px'}} className='blog-content'>
            ...
            <p>He abierto cupos de consultoría personalizada por sólo $15.</p>
            ...
            <p>Normalmente el precio de esta consultoría es de $150... Pero aprecio que me has seguido y por eso voy a darte la oferta por sólo $15.</p>
            <p>Puedes agendar una llamada haciendo click en el botón de abajo...</p>
          </div>
        </div>
        <div style={{textAlign: "center", marginTop: '-50px'}}>
          <div style={{textAlign: 'center'}}>
            <button onClick={this.sendToLinkedIn} type="button" style={{marginBottom: '40px', fontWeight: 'bold', padding: '12px' }} className="btn btn-success">Agendar Llamada</button>
          </div>
        </div>
      </div>
    )
