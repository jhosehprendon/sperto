    ...
    <div>
      <div>
        <div style={{textAlign: 'center', color: '#283d54', marginTop: '20px'}}>
          ...
          <iframe title="video3" type="text/html" frameborder="0" className="video" src="https://www.youtube.com/embed/RwrlNec8XgU" allowfullscreen></iframe>
        </div>
      </div>
    </div>
  )
...
export default SecuenciaVideo3Consulta