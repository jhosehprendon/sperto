  ...
  render() {
    return ( 
      ...
      <div className='home-first'>
        <div className='home-first--flex over'>
          <div style={{marginRight: '10%'}}>
            <h2 className='home-first__title'>Consigue más Candidatos Calificados y Cubre más Vacantes en menos Tiempo</h2>
            <h3 className='home-first__subtitle'>Entrenamos a Reclutadores a Ejecutar Sistemas de Marketing Efectivos</h3>
            {/* <button onClick={this.sendToConsulta} type="button" style={{marginTop: '10px', fontWeight: 'bold', fontSize: '16px', padding: '12px' }} className="btn btn-success">Únete a la Academia</button> */}
          </div>
        </div>
      </div>
      ...
      <div style={{ backgroundColor: '#9dccfa', padding: '3%', textAlign: 'center' }}>
        <p className="banner-first" style={{padding: '30px', display: 'inline'}}>Aprende más sobre el Sistema de Marketing para Reclutamiento</p>
        <button onClick={this.sendToLlamada} type="button" style={{fontWeight: 'bold', fontSize: '16px', padding: '12px' }} className="btn btn-light">Agendar Llamada</button>
      </div>
      <div style={{ backgroundColor: '#66b3ff', height: '10px' }}>
      </div>
      <div style={{ paddingTop: '4%'}}>
        <h2 style={{textAlign: 'center', color: '#295b8d', fontWeight: 'bold'}}>Cómo podemos ayudarte</h2>
        <hr style={{backgroundColor: '#3a8dde', width: '80px'}}></hr>
        <p style={{textAlign: 'center', color: '#295b8d', fontSize: '20px', width: '65%', margin: '5rem auto 0'}}>Entrenamos a dueños de agencias, managers y reclutadores a ejecutar Sistemas de Marketing que les permite construir relaciones con el mejor talento.</p>
        <div className="row" style={{paddingTop: '3%'}}>
          <div className="info-block">
            <Card>
              <div style={{margin: '10px 0 4px 0px'}}>
                  <h5 style={{color: '#295b8d', textAlign: 'center'}}>Agencias de Staffing</h5>
              </div>
            </Card>
            <Card>
              <div style={{margin: '10px 0 4px 0px'}}>  
            ...
            <Card>
              <div style={{margin: '10px 0 4px 0px'}}>  
                  <h5 style={{color: '#295b8d', textAlign: 'center'}}>Empresas IT</h5>
              </div>
            </Card>
            <Card>
              <div style={{margin: '10px 0 4px 0px'}}>  
                  <h5 style={{color: '#295b8d', textAlign: 'center'}}>Reclutadores</h5>
              </div>
            </Card>
          </div>
        </div>
      ...
      <div style={{ backgroundColor: 'white', padding: '3%', width: '65%', margin: 'auto' }}>
        <p style={{textAlign: 'center', color: '#283d54', fontWeight: 'bold', fontSize: '24px', margin: 'auto'}}><i className="fas fa-quote-left" style={{marginRight: '8px', color: '#f2c924'}}></i>Creemos en el poder del Marketing para Crear una Relación con tus Candidatos<i className="fas fa-quote-right" style={{marginLeft: '8px', color: '#f2c924'}}></i></p>
      </div>
    </div>
    )
  }
