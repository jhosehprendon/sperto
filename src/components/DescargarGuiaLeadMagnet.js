...
class DescargarGuiaLeadMagnet extends React.Component {
  componentDidMount() {
    window.scrollTo(0, 0)
  }
      ...
      <div className='blog-block'>
        <div className='blog-content'>
          <div style={{textAlign: 'center'}}>
            ...
            <Link to="/files/lead_magnet_formula.pdf" target="_blank" download>
...
export default DescargarGuiaLeadMagnet